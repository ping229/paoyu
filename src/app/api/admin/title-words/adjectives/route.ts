...
export async function GET(request: NextRequest) {
  try {
    ...
    const words = await prisma.titleAdjective.findMany({
...
export async function POST(request: NextRequest) {
  try {
    ...
    // 检查是否已存在
    const existing = await prisma.titleAdjective.findUnique({
    ...
    const newWord = await prisma.titleAdjective.create({
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    await prisma.titleAdjective.delete({
      where: { id }
    })
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updated = await prisma.titleAdjective.update({
      where: { id },
      data: { isActive }
    })
